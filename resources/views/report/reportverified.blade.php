...
yang bersangkutan &nbsp&nbsp&nbsp Bawahan 
            ...
            <br><a href="/report/addReport" class="btn btn-success btn-md btn-save-act" fdprocessedid="203w3e"><i class="fas fa-plus"></i><span>Lapoaran</span></a>
            &nbsp<a href="/report/minggu" class="btn btn-success btn-md btn-save-act" fdprocessedid="203w3e"><span>Minggu ini</span></a>
            &nbsp<a href="/report/bulan" class="btn btn-success btn-md btn-save-act" fdprocessedid="203w3e"><span>Bulan ini</span></a>
            <div class="col-lg-10" id="c_sndmsg" data-select2-id="c_sndmsg">
            <div class="row">
                 <div class="col-md-4">
